...
(function ($) {
    ...
    var defaultLayoutTemplates = {
        ...
        preview: '<div class="file-preview {class}">\n' +
            '   <div class="close fileinput-remove text-right"><i class="fa fa-remove"></i></div>\n' +
    ...
    $.fn.fileinput.defaults = {
        ...
        browseLabel: ' Attach Photos',
        browseIcon: '<i class="fa fa-image"></i> &nbsp;',
        browseClass: 'btn btn-primary btn-lg tinyVoicesBtnRegister',
        removeLabel: 'Remove',
        removeIcon: '<i class="fa fa-remove"></i> ',
        removeClass: 'btn btn-primary btn-lg tinyVoicesBtnBG',
        uploadLabel: 'Upload',
        uploadIcon: '<i class="glyphicon glyphicon-upload"></i> ',
        uploadClass: 'btn btn-lg btn-default tinyVoicesBtnRegister',
        uploadUrl: null,
        maxFileSize: 3000,
        maxFileCount: 0,
        msgSizeTooLarge: 'File "{name}" (<b>{size} KB</b>) exceeds maximum allowed upload size of <b>{maxSize} KB</b>. Please upload images with smaller size',
